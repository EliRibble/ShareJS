  ...
  */
  ...
  Connection = (function() {
    function Connection(host, authentication) {
      var authRequestStart,
        _this = this;
      this.docs = {};
      this.state = 'connecting';
      this.authRequestLatency = 0;
      this.clientServerTimeOffset = 0;
      authRequestStart = null;
      this.localTimeToServerTime = function(localTime) {
        return localTime + _this.clientServerTimeOffset;
      };
      this.serverTimeToLocalTime = function(serverTime) {
        return serverTime - _this.clientServerTimeOffset;
      };
      if (socketImpl == null) {
        if (host.match(/^ws:/)) {
          socketImpl = 'websocket';
      ...
      this.socket.onmessage = function(msg) {
        ...
        if (msg.auth === null) {
          ...
          _this.authRequestLatency = authRequestEnd - authRequestStart;
          _this.clientServerTimeOffset = (msg.timestamp - new Date().getTime()) + _this.authRequestLatency;
          _this.setState('ok');
          return;
        }
        docName = msg.doc;
